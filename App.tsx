...
type Page = 'home' | 'blog' | 'blog-article' | 'privacy' | 'app-support' | 'directory' | 'seo-page' | 'agenti-ai' | 'tracking' | 'technical-partner' | 'meta-advertising' | 'case-studies' | 'case-study' | '404';
