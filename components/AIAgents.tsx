...
const AIAgents: React.FC = () => {
  ...
  // Ordine dello stagger d'ingresso: eyebrow, h1, sottotitolo, CTA, visual.
  const reveal = useHeroReveal<HTMLElement>(5);
