    ...
    <article className="relative pt-36 pb-28 px-6 bg-[#050505] text-white min-h-screen overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <header className="mb-14">
          ...
          <h1 className="text-[clamp(40px,6.5vw,80px)] font-bold tracking-tight mb-6">{page.title}</h1>
          <p className="text-lg md:text-xl text-gray-300 leading-relaxed max-w-3xl">{page.description}</p>
        </header>

        {/* Direct Answer for GEO */}
        <section className="mb-16 rounded-3xl border border-indigo-400/30 bg-indigo-500/[0.06] p-8">
          <h2 className="text-2xl md:text-3xl font-bold mb-4">Risposta diretta</h2>
          <p className="text-lg md:text-xl text-gray-200 leading-relaxed">{page.directAnswer}</p>
        </section>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-16">
          <section className="rounded-3xl border border-white/10 bg-white/[0.03] p-6">
            <h2 className="text-2xl font-bold mb-3">Per chi</h2>
            <p className="text-gray-400 leading-relaxed">{page.audience}.</p>
          </section>
          <section className="rounded-3xl border border-white/10 bg-white/[0.03] p-6">
            <h2 className="text-2xl font-bold mb-3">Problema</h2>
          ...
          <section className="rounded-3xl border border-indigo-400/30 bg-indigo-500/[0.06] p-6">
            <h2 className="text-2xl font-bold mb-3">Risultato</h2>
        ...
        <section className="mb-16">
          <h2 className="text-[clamp(28px,4.5vw,48px)] font-bold mb-6">Dati e risultati</h2>
        ...
        {/* Keyword Clusters */}
        <section className="mb-16">
          <h2 className="text-[clamp(28px,4.5vw,48px)] font-bold mb-6">Argomenti correlati</h2>
          <div className="space-y-6">
            {page.clusters.map((cluster) => (
              <section key={cluster.keyword} className="rounded-2xl border border-white/10 bg-white/[0.03] p-6">
                <h3 className="text-2xl font-semibold mb-3 text-indigo-200">{cluster.heading}</h3>
        ...
        {page.comparisonTable && (
          <section className="mb-16">
            <h2 className="text-[clamp(28px,4.5vw,48px)] font-bold mb-6">{page.comparisonTable.title}</h2>
        ...
        <section className="mb-16">
          <h2 className="text-[clamp(28px,4.5vw,48px)] font-bold mb-5">Come interveniamo</h2>
        ...
        <section className="mb-16">
          <h2 className="text-[clamp(28px,4.5vw,48px)] font-bold mb-6">FAQ</h2>
        ...
        <section>
          <h2 className="text-[clamp(28px,4.5vw,48px)] font-bold mb-6">Pagine correlate</h2>
